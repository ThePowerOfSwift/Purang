...
// JXBAdPageView
#define COCOAPODS_POD_AVAILABLE_JXBAdPageView
#define COCOAPODS_VERSION_MAJOR_JXBAdPageView 1
#define COCOAPODS_VERSION_MINOR_JXBAdPageView 0
#define COCOAPODS_VERSION_PATCH_JXBAdPageView 0
