...
//            photoViewController.photoImageView.image = image;
...
{
    NSLog(@"camera usePhoto");
    [_delegate getPhoto:imageDictionary];
    [self.navigationController popToViewController:[DiscountPhotoViewController shareDiscountPhotoViewController] animated:YES];
